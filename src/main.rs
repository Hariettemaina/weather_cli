...
// struct to desierialize the json responsse from openweatherapi
#[derive(Deserialize, Debug)]
struct WeatherResponse {
    weather: Vec<Weather>, //all wethear info
    main: Main,            // weather parametes
    wind: Wind,
    name: String, //queried location
}
...
//Function to get the weather info feom the open weatherapi
fn get_weather_info(
    city: &str,
    country_code: &str,
    api_key: &str,
...
fn main() {
    ...
    loop {
        ...
        let api_key = "25b6f41f69f1c3fdd074c6d9fc4f5d9e";
